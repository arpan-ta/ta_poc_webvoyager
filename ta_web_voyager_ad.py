...
async def to_homepage(state: AgentState):
    page = state["page"]
    await page.goto("https://anishadesai-ta.github.io/companydemo/")
...
prompt = hub.pull("ani/web-voyager_adapted_signin")
...
_ = await page.goto("https://anishadesai-ta.github.io/companydemo/")
